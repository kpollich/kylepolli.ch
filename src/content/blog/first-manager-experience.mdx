...
- Deliver direct, critical feedback to people as quickly as possible instead of avoiding conflict
- Personal willpower can brute force technical blockers, not org or political ones
- Self assignment workflows build more ownership than top down task assignment
- One on ones are the highest leverage time a manager has
- Absorb vs escalate is a calibrated skill, use visible progress plus explicit asks to unblock via leadership
- Light process beats heavy ceremonies, be allergic to meetings
- Skipping planning is expensive - an hour of planning can avoid two weeks of costly rework
...
- A single hour long weekly catch-all meeting for ongoing work check-in, issue grooming, upcoming iteration planning, unblocking, technical discussions, etc
- Dedicated retrospective meetings every six weeks
- Biweekly one-on-ones between my reports and me
- Biweekly one-on-ones between my more senior engineers and their more junior teammates
- Smaller, per-project working group meetings either weekly or biweekly
