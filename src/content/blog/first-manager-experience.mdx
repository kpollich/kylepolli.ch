...
I'm cautiously looking forward to heading back to an IC role with all of these learnings from my time as a manager, even if the circumstances that put me here are less than ideal. I'd be remiss if I didn't mention Charity Majors' [great article](https://charity.wtf/2017/05/11/the-engineer-manager-pendulum/) about the pendulum between IC and manager roles. I feel like there are growth opportunities on both sides of that pendulum, and I'm grateful to get the chance to operate on both types of roles with the same domain over multiple years.
