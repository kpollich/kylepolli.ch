  ...
  [15],
  {
      ...
      var u = o.a.createContext({}),
        ...
        y = o.a.forwardRef(function (e, t) {
          var n = e.components,
            ...
            u = d(n),
            p = r,
            m = u[''.concat(i, '.').concat(p)] || u[p] || f[p] || c;
          return n
            ? o.a.createElement(m, s(s({ ref: t }, a), {}, { components: n }))
            : o.a.createElement(m, s({ ref: t }, a));
        });
      function j(e, t) {
        var n = arguments,
          r = t && t.mdxType;
            ...
            i(() => {
              const t = window.requestIdleCallback(() => {
                const i = { mdx: o, ...a, ...n },
                  ...
                  d = r.createElement(c, { components: a }, p);
                l(d), window.cancelIdleCallback(t);
              });
            }, [e]),
          s
        );
    ...
    OeCL: function (e, t, n) {
      ...
      var r = n('nKUr'),
        ...
        a = n('+ego'),
        s = n('UYbT'),
        l = o.d.div.withConfig({
          displayName: 'uses__Content',
          componentId: 'sc-6a1d5v-0',
        })(['p{margin:0;}img{width:100%;}']),
        u = !0;
        ...
        return Object(r.jsxs)(a.a, {
          children: [
            Object(r.jsx)(s.a, {
              title: 'Uses',
              description:
                "These are some of the things I use to write code, organize my thoughts, and try to stay productive. I'm always trying out new apps and gadgets, so don't consider this list exhaustive or complete.",
            }),
            Object(r.jsxs)('section', {
              children: [
                Object(r.jsx)('h1', { children: 'Uses' }),
                Object(r.jsx)('p', {
                  children:
                    "These are some of the things I use to write code, organize my thoughts, and try to stay productive. I'm always trying out new apps and gadgets, so don't consider this list exhaustive or complete.",
                }),
                Object(r.jsx)(l, { children: n }),
              ],
            }),
          ],
        });
      ...
      var r = n('nKUr'),
        ...
        p = function (e) {
          var t = e.title,
            ...
            d = e.article,
            m = void 0 !== d && d,
            f = Object(o.useRouter)().pathname,
            y = {
              title: t || a,
              description: n || l,
              image: ''.concat(i).concat(p || s),
              url: ''.concat(i).concat(f),
            };
          return Object(r.jsxs)(c.a, {
            ...
            children: [
              ...
              Object(r.jsx)('meta', { name: 'image', content: y.image }),
              y.url &&
                Object(r.jsx)('meta', { property: 'og:url', content: y.url }),
              !m
                ? null
                : Object(r.jsx)('meta', {
                    property: 'og:type',
