_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [7],
  {
    ...
    IKlv: function (e, t, r) {
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 7:
                      ...
                      break;
                    case 16:
                      return (e.next = 18), J.routeLoader.whenEntrypoint(M);
                    case 18:
                      e.t0 = e.sent;
                    case 19:
                      if (!('error' in (u = e.t0))) {
                    ...
                    case 36:
                      return (
                        (t.router = z = (0, N.createRouter)(M, F, W, {
                          initialProps: L,
                          pageLoader: J,
                          App: Z,
                          Component: Q,
      ...
      var le = function (e) {
        return function (t) {
          var r = (0, m.default)({}, t, { Component: Q, err: R, router: z });
          return h.default.createElement(
            fe,
            null,
      ...
      function pe(e) {
        ...
        return (
          ...
          'function' === typeof v.default.hydrate
            ? v.default.hydrate(f, l, ue)
            : v.default.render(f, l, ce),
          s
        );
      }
      function de(e) {
