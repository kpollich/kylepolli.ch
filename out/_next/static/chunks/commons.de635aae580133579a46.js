                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 27:
                              (O = e.sent), O.__rewrites, (e.next = 35);
                              break;
                            case 31:
                              return (
                                (e.prev = 31),
                            ...
                            case 35:
                              if (
                                ((f = this._resolveHref(f, b)).pathname !== y &&
                                  ((y = f.pathname),
                                  (n = (0, h.formatWithValidation)(f))),
                                (y = y
                                  ? (0, c.removePathTrailingSlash)(k(y))
                                  : y),
                              ...
                              if (
                                ((D = (0, v.parseRelativeUrl)(A)),
                                (M = D.pathname),
                                (N = (0, g.getRouteRegex)(j)),
                                (U = (0, m.getRouteMatcher)(N)(M)),
                                (q = (W = j === M) ? R(j, M, w) : {}),
                                U && (!W || q.result))
                              ) {
                                e.next = 58;
                            ...
                            case 63:
                              ...
                              if (
                                ...
                                this._resolveHref(J, b, !1),
                                !b.includes(J.pathname))
                              ) {
                                e.next = 73;
                                break;
                              }
                              return (
                                ...
                                (Y = $.url),
                                (Q = $.as),
                                e.abrupt('return', this.change(r, Y, Q, i))
                              );
                            case 73:
                              return (
                            ...
                            case 80:
                              ...
                              throw (
                                (t.events.emit('routeChangeError', B, l), B)
                              );
                            case 83:
                              return (
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 6:
                              if (
                                ((e.prev = 6),
                                !(h = 'SSG Data NOT_FOUND' === r.message))
                              ) {
                                e.next = 24;
                                break;
                              }
                            ...
                            case 46:
                              return (
                                ...
                                e.abrupt(
                                  'return',
                                  this.handleRouteInfoError(e.t2, n, a, i, !0)
                                )
                              );
                            case 49:
                            case 'end':
          ...
          (t.mark = function (t) {
            return (
              Object.setPrototypeOf
                ...
                : ((t.__proto__ = h), i in t || (t[i] = 'GeneratorFunction')),
